...
<div class="test container">
  ...
  <div class="row">
    ...
    <div class="col-10 px-3 bg-opacity">
      <div class="show-product px-4 d-flex flex-column w-50">
        <div id="search-bar" class="search-bar border border-dark d-flex flex-row w-100">
          <input type="text" class="form-control " id="search-input" placeholder="Search..." style="border: 0px;">
